...
class MyOrderAdapter(var context: Context, val appClickListener: AppClickListener) :
    RecyclerView.Adapter<MyOrderAdapter.ViewHolder>(), View.OnClickListener {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(context).inflate(R.layout.item_my_order, parent, false)

...
public class CustomViewPager extends ViewPager implements ViewPager.PageTransformer {
    ...
    public CustomViewPager(Context context, AttributeSet attrs) {
        ...
        setPadding(mPageMargin, dp2px(context.getResources(), 20), mPageMargin, dp2px(context.getResources(), 20));
        //   setPadding(dp2px(context.getResources(), 10), dp2px(context.getResources(), 20), dp2px(context.getResources(), 10), dp2px(context.getResources(), 20));
    ...
    public void transformPage(View page, float position) {
        if (mPageMargin <= 0 || !animationEnabled)
            return;
        page.setPadding(mPageMargin / 2, 0, mPageMargin / 2, 0);

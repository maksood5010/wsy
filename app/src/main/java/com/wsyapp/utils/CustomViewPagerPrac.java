...
public class CustomViewPagerPrac extends ViewPager implements ViewPager.PageTransformer {
    ...
    public CustomViewPagerPrac(Context context) {
        this(context, null);
    }

    public CustomViewPagerPrac(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void transformPage(View page, float position) {
        if (mPageMargin <= 0|| !animationEnabled)
            return;
        page.setPadding(18, 0, mPageMargin / 2, 0);
